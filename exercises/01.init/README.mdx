...
NOTE: you can now do this elaboration within the workshop material instructions 
file itself rather than in this form if you prefer. 
Please write (in your own words) a few of the core concepts you 
learned from the exercise. 
Answering this question is an important part of the learning 
and retention experience.

It is an SPA with the landing page where it lists the spaceships with links 
to the detail page of individual space ships and it is achieved with out many libraries and tools. 
Hono similar to express server serves index file and assets, api data needed for the client 
